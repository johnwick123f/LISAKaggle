...
model = LISAForCausalLM.from_pretrained(
    "xinlai/LISA-13B-llama2-v1-explanatory", max_memory={"cpu": "12GIB"}, low_cpu_mem_usage=True, use_cache=True, offload_folder="offload", offload_state_dict=True, seg_token_idx=args.seg_token_idx, **kwargs
)
