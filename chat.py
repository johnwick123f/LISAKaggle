...
def main(args):
    ...
    model = LISAForCausalLM.from_pretrained(
        "xinlai/LISA-13B-llama2-v1-explanatory", low_cpu_mem_usage=True, use_cache=True, seg_token_idx=args.seg_token_idx, offload_folder="/content/offload1", offload_state_dict = True, **kwargs
    )
